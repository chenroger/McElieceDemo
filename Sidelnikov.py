        ...
        for errors in errors_tbit:
            if errors[1] == s_mSG:
                ...
                s_recover = (recover * H_matrix.T).applyfunc(
                								   lambda x: mod(x,2))
                mSG = recover
        mS = mSG.extract([0], list(range(k_val)))
...
if args.vv:
    args.v = True
if args.g and args.m and args.r and args.o:
    keygen(args.r, args.m, args.o)
